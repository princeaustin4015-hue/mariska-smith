...
export default function Footer() {
    ...
    return (
        ...
        >
            ...
            {/* Black overlay for highlight and readability */}
            <div className="absolute inset-0 bg-black/80 z-0"></div>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 roomy-copy relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Brand Section */}
                    <div className="col-span-1 md:col-span-2">
                        <div className="mb-6">
                            <h3 className="text-2xl font-bold text-white mb-2 font-cursive">
                        ...
                        <div className="flex space-x-4">
                            <a
                                ...
                                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-gray-400 hover:text-black hover:bg-[var(--accent-gold)] transition-all duration-300"
                            >
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-white font-semibold mb-4 font-cursive">Quick Links</h4>
                        <ul className="space-y-2">
                            <li><a href="#games" className="text-gray-400 hover:text-white transition-colors duration-300">Games</a></li>
                    ...
                    {/* Support */}
                    <div>
                        <h4 className="text-white font-semibold mb-4 font-cursive">Support</h4>
                        <ul className="space-y-2">
                            <li><a href="#help" className="text-gray-400 hover:text-white transition-colors duration-300">Help Center</a></li>
                ...
                {/* Bottom Bar */}
                <div className="border-t border-[rgba(255,210,74,0.2)] mt-12 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex items-center space-x-4 mt-4 md:mt-0">
                            ...
                            <span className="text-gray-500 text-sm">for gamers worldwide</span>
                        </div>
                    </div>
                </div>
            </div>
