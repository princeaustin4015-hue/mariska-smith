...
export default function LeaderboardForm({ item, onClose, onSuccess }: LeaderboardFormProps) {
        ...
        <div className="flex justify-between items-start">
          <div>
            <CardTitle className="text-white font-cursive">
              {item ? 'Edit Leaderboard' : 'Create Leaderboard Item'}
            </CardTitle>
            <CardDescription className="text-gray-400">
              {item ? 'Update leaderboard details' : 'Add a new leaderboard item'}
            </CardDescription>
          </div>
